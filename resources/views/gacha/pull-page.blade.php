            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-1">
                    <div class="grid gap-6 lg:grid-cols-1 lg:gap-12">
                        <div id="gachaContainer" class="flex flex-col gap-3 lg:grid-cols-3">
                            <div class="flex flex-col items-center gap-4">
                                <div id="docs-card"
                                    class="flex flex-col items-start gap-12 overflow-hidden rounded-lg justify-center bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                    <!-- Loading indicator -->
                                ...
                                <div class="w-auto flex items-center justify-between mb-4">
                                    ...
                                    <div class="flex pt-3 sm:pt-5 ml-5 justify-end">
                                        ...
                                        <a href="{{ route('gacha.reset') }}"
                                            class="text-xl font-semibold text-black dark:text-white rounded px-4 py-2  text-gray-900 cursor-pointer hover:bg-blue-200 focus:text-blue-700 focus:bg-blue-200 focus:outline-none focus:ring-blue-600">
                                            Reset
                                        </a>
                                    </div>
                                </div>
