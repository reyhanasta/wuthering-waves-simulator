<main>
    ...
    <div id="inventory-modal" tabindex="-1" aria-hidden="true" x-transition
        ...
        <div class="relative w-full max-w-2xl max-h-full p-4">
            <!-- Modal content -->
            <div class="relative bg-gray-800 border-2 border-black shadow rounded-2xl">
                <!-- Modal header -->
    ...
    <div id="detail-note-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-2xl max-h-full p-4 ">
            <!-- Modal content -->
            <div class="relative bg-gray-800 border-2 border-yellow-300 shadow rounded-2xl">
                <!-- Modal header -->
                <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-black">
                    <h3 class="text-xl font-semibold text-white">
                        Rate Details
                ...
                <div class="relative text-white p-7">
