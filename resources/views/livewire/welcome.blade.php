    ...
    <div>
        ...
        <div class="grid grid-cols-1 gap-6 p-6 md:grid-cols-3">
            <div class="relative cursor-pointer group">
                <img src="{{ Storage::url('public/images/background/gacha-banner-2.jpg') }}" alt="Standard Banner"
            ...
            <div class="relative cursor-pointer group">
                <img src="{{ Storage::url('public/images/background/gacha-banner-2.jpg')}}" alt="Weapon Banner"
                    class="w-full transition-transform duration-300 rounded-lg shadow-lg group-hover:scale-105">
                <div class="absolute bottom-0 w-full p-2 text-center text-white bg-black bg-opacity-50">
                    Weapon Banner
                </div>
            ...
            <div class="relative cursor-pointer group">
                <img src="{{ Storage::url('public/images/background/gacha-banner-2.jpg') }}" alt="Limited Banner"
                    class="w-full transition-transform duration-300 rounded-lg shadow-lg group-hover:scale-105">
                <div class="absolute bottom-0 w-full p-2 text-center text-white bg-black bg-opacity-50">
                    Limited Banner
                </div>
